...
/**
  ...
  */
object CrdtrealtimeDetails {

  val conf = new SparkConf().setAppName("crmClientOutline_crdtrealtimeDetails")
  ...
  def main(args: Array[String]): Unit = {
    ...
    sc.setLogLevel("WARN")
    val kafkaReader = new KafkaReader[String, String, StringDecoder, StringDecoder](ssc, Utils.brokerList, Utils.topicOggCrdtrealtime,
    ...
    insertRecords.foreachRDD(rdd => {
      ...
      val crdtrealtime_details = hvc.read.json(rdd)
